...
index.html - Homepage with Search and Station Grid.
...
css/style.css - All styling (Responsive, Flexbox/Grid).

js/main.js - Application logic.

How to Run

Download all files and keep the folder structure.
...
Go to "Profile" to edit your vehicle details.
...
Charge History: Track your charging sessions dynamically.

Project Structure

index.html: Home dashboard with advanced filtering and station grid.

login.html & register.html: Secure user authentication simulation.

profile.html: User management, Favorite stations, and Charging history.

css/style.css: Modern responsive UI with Flexbox/Grid and Glassmorphism.

js/main.js: Core application logic, filtering engine, and state management.

How to Run

Open index.html in any modern browser.

Search and filter for stations on the home page.
